...
export function SecureAboutPage() {
  return (
    <div className="p-8 md:p-12 max-w-5xl mx-auto h-full font-sans text-fbsb-text-secondary pb-32 overflow-y-auto">
      <div className="flex items-center space-x-6 mb-10 pb-6 border-b border-fbsb-border bg-[#141414] p-6 rounded-2xl shadow-premium border border-white/5">
         <div className="h-20 flex items-center justify-center">
            <img src="/logo-flecha.png" alt="FLECHA BSB Logo" className="h-20 w-auto object-contain filter invert hue-rotate-180 brightness-[1.5] contrast-[1.2]" />
         </div>
         <div>
           <h1 className="text-3xl font-bold text-white tracking-tight">Ambiente Seguro</h1>
      ...
      <div className="space-y-12">
        ...
        <section className="bg-[#141414] p-10 rounded-2xl shadow-premium border border-white/5 text-center relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-4 max-w-4xl mx-auto relative z-10">
             <div className="bg-[#0A0A0A] px-6 py-4 rounded-xl border border-white/5 flex-1 w-full flex flex-col items-center justify-center">
                <Lock className="w-5 h-5 text-fbsb-cyan mb-2" />
                <p className="text-xs font-medium text-white text-center">A informação é compartilhada<br/>somente entre usuários autorizados.</p>
             </div>
             <div className="bg-[#0A0A0A] px-6 py-4 rounded-xl border border-white/5 flex-1 w-full flex flex-col items-center justify-center">
                <Activity className="w-5 h-5 text-fbsb-primary-light mb-2" />
                <p className="text-xs font-medium text-white text-center">A conversa existe somente<br/>durante a sessão.</p>
             </div>
             <div className="bg-[#0A0A0A] px-6 py-4 rounded-xl border border-white/5 flex-1 w-full flex flex-col items-center justify-center">
                <Layers className="w-5 h-5 text-fbsb-success mb-2" />
                <p className="text-xs font-medium text-white text-center">O documento é analisado<br/>antes do envio definitivo.</p>
             </div>
          </div>
