          ...
          <div className="flex items-center gap-3">
             <div className="relative">
                ...
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#00d4ff] to-[#a78bfa] p-0.5 shadow-glow-cyan overflow-hidden">
                   <img src="https://i.ibb.co/6y4VjL7/bot.png" alt="Flecha IA" className="w-full h-full object-cover rounded-[10px]" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
         ...
         >
           {isOpen ? (
             ...
             <div className="w-full h-full relative overflow-hidden rounded-full p-1 bg-fbsb-bg-deep flex items-center justify-center group-hover:bg-fbsb-surface-100 transition-colors">
               <img src="https://i.ibb.co/6y4VjL7/bot.png" alt="Flecha IA" className="w-full h-full object-cover scale-110 drop-shadow-lg z-10" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
